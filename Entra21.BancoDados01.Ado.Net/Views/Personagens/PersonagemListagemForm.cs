...
namespace Entra21.BancoDados01.Ado.Net.Views.Personagens
{
    ...
    {
        //Definindo como readonly será permitida a criação da instancia somente no construtor "_" sempre vai na frente quando for readonly
        private readonly PersonagemService _personagemService;

        //Aqui fica o construtor: tem como objetivo construir o objeto com propriedades necessarias e execução de métodos obrigatorios, ou seja, neste cenário desenhar a tela e instanciar o objeto do serviço que permitirá gerenciar os dados referente ao personagem

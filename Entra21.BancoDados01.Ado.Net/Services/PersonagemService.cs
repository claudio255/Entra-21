...
namespace Entra21.BancoDados01.Ado.Net.Services
{
    internal class PersonagemService : IPersonagemService
    {
        public void Apagar(int id)
        {
            ...
            //Substituir os @ no comando da query que seré executada no banco de dados, prevenindo SQL Injection
        ...
        public void Cadastrar(Personagem personagem)
        {
            ...
            //Substituir os @ do inseert com os valores preenchidos pelo usuario
        ...
        public Personagem ObterPorId(int id)
        {
            ...
            personagem.Id = Convert.ToInt32(registro[0]);
